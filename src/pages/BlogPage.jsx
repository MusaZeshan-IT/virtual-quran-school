        ...
        <div>
            ...
            <div className='my-28 2xl:px-24 xl-custom:px-20 xl:px-16 lg-custom:px-14 lg:px-12 md-custom:px-10 px-8'>
                <div className='flex gap-x-10'>
                    <div className="flex flex-col gap-y-12 w-[73%]">
                        {posts.map((post, index) => (
                            <div key={index} className='rounded-md bg-white shadow-[0_0_5px_1px_rgba(0,0,0,0.3)]'>
                                ...
                                <div className='p-6'>
                                    ...
                                    <h1 className='mt-4 text-[32px] text-gray-950 leading-[40px] font-black font-cinzel-decorative'>{post.title}</h1>
                                    <p className='text-gray-700 font-poppins mt-3'>{post.main_description}</p>
                                ...
                                <div className='flex flex-col'>
                                    {posts.map((post, index) => (
                                        <div key={index} className='flex mt-8 flex-col cursor-pointer border-b border-gray-300 pb-4'>
                                            <img className='w-full h-32 rounded shadow-[0_0_2px_0.5px_rgba(0,0,0,0.3)]' src={post.image} alt="" />
                                            <div>
