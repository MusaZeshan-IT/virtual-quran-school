        ...
        <div className='rounded-lg px-5 py-6 w-full bg-white shadow-[0px_0px_3px_0.1px_rgb(0,0,0)] font-inter'>
            ...
            <div className='border-y mt-4 py-1 border-gray-300 flex items-center justify-between'>
                <div className="flex flex-col">
                    <span className='text-amber-600 text-[17px] font-bold'>{plan.number_of_classes_per_week} per week</span>
                ...
                <div className="flex flex-col">
                    <span className='text-amber-600 text-[17px] font-bold'><span className='me-[1px]'>$</span>{course.fee}</span>
