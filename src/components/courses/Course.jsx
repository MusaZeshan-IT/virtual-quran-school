...
const Course = ({ course, courseName, courseFor, courseDuration, courseClassTime, studentsEnrolled, courseFee }) => {
    return (
        <div className='rounded-lg px-6 py-4 w-full bg-gray-100 shadow-[0px_0px_3px_0.1px_rgb(0,0,0)] font-poppins'>
            ...
            <div className='border-y mt-4 py-1 border-gray-300 flex justify-between'>
                <div className="flex flex-col">
                    <span className='text-amber-600 text-[17px] font-poppins font-black'>{courseDuration}</span>
                    <span className='font-semibold'>Duration</span>
                </div>
                <div className="flex flex-col">
                    <span className='text-amber-600 text-[17px] font-poppins font-bold'>{courseClassTime}</span>
                    <span className='font-semibold'>Class Time</span>
                </div>
                <div className="flex flex-col">
                    <span className='text-amber-600 text-[17px] font-poppins font-bold'>{studentsEnrolled}</span>
                    <span className='font-semibold'>Enroll</span>
                </div>
            </div>
            <p className='text-[rgb(133,128,128)] mt-6'>{courseFor}</p>
            <div className="flex justify-between items-end">
                <Link to={`/courses/${course.urlName}/`}>
