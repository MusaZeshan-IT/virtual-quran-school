        ...
        <div className='rounded-lg px-5 py-6 w-full bg-white shadow-[0px_0px_3px_0.1px_rgb(0,0,0)] font-inter'>
            ...
            <div className='border-y mt-4 py-1 border-gray-300 flex items-center justify-between'>
                <div className="flex flex-col">
                    <span className='text-amber-600 text-[17px] font-bold'><span className='me-[1px]'>$</span>{plan.fee}</span>
                    <span className='font-semibold'>Price</span>
                </div>
                <div className="flex flex-col">
                    <span className='text-amber-600 text-[17px] font-bold'>
                        {plan.number_of_classes_per_week} days<span className='mx-[2px]'>/</span>week
                    </span>
                    <span className='font-semibold'>Sessions</span>
                </div>
                <div className="flex flex-col">
                    <span className='text-amber-600 text-[17px] font-bold'>{course.level}</span>
            ...
            <div className="flex justify-between items-end">
                <Link to={`/courses/${course.slug}/`} state={{ plan }}>
                    <button className='bg-amber-600 text-white h-11 grid place-items-center text-sm font-semibold px-5 rounded-[5px] mt-6'>
                        Study Now
                    </button>
                </Link>
                <div className="flex flex-col">
