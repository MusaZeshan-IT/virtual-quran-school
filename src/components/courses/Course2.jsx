    ...
    return (
        <div className='rounded-lg px-5 py-6 w-full bg-white shadow-[0px_0px_3px_0.1px_rgb(0,0,0)] font-inter'>
            ...
            <div className="flex justify-between items-end">
                <Link to={`/coursePlans/${course.slug}/`}>
                ...
                <div className='bg-[rgb(226,236,232)] px-5 py-[9px] rounded-[7px] mt-6'>
                    <span className='text-[17px] font-inter font-semibold border-b-[1px] border-gray-500'>
                        <span className='me-[2px] text-[16.5px]'>$</span>{course.fee}
                    </span>
                </div>
            </div>
        </div>
