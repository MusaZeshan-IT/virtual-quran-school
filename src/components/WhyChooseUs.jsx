...
const WhyChooseUs = () => {
    return (
        <div>
            ...
            <div className='grid lg:grid-cols-4 xs-custom:grid-cols-2 grid-cols-1 xl:gap-8 lg-custom:gap-8 lg:gap-5 gap-8 mt-14'>
                <div className='flex flex-col items-center shadow-[0_2px_10px_0_rgba(0,0,0,0.2)] transition-transform transform hover:scale-105 hover:shadow-[0_2px_15px_0_rgba(0,0,0,0.2)] rounded-lg xl:p-7 lg-custom:p-5 p-5'>
                ...
                <div className='flex flex-col items-center shadow-[0_2px_10px_0_rgba(0,0,0,0.2)] transition-transform transform hover:scale-105 hover:shadow-[0_2px_15px_0_rgba(0,0,0,0.2)] rounded-lg xl:p-7 lg-custom:p-5 p-5'>
                    ...
                    <h3 className='text-[20px] text-gray-900 font-inter font-semibold mt-4 text-center'>Male/Female Teachers</h3>
