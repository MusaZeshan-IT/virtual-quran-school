    ...
    return (
        <div className="relative h-[600px] w-full">
            ...
            >
                ...
                ></div>
                <div className="relative top-32 z-10 px-20 text-white">
                    <div className='grid grid-cols-3'>
                        <div>
                            <div>
                                <h4 className="mb-0 font-cinzel-decorative text-2xl">Information</h4>
                                <p className="mb-0 mt-10 leading-[26px] text-[16px] w-11/12 font-poppins">
                            ...
                            <div className="inline-flex items-center mt-10">
                                <a className='border-r-2 border-[rgb(161,155,155)] hover:text-orange-500 pe-5' href="https://twitter.com" title="Twitter" itemprop="url" target="_blank"><i class="fa-brands text-lg fa-twitter"></i></a>
                                <a className='border-r-2 border-[rgb(161,155,155)] hover:text-orange-500 px-5' href="https://facebook.com" title="Facebook" itemprop="url" target="_blank"><i class="fa-brands text-lg fa-facebook-f"></i></a>
                                <a className='border-r-2 border-[rgb(161,155,155)] hover:text-orange-500 px-5' href="https://linkedin.com" title="Linkedin" itemprop="url" target="_blank"><i class="fa-brands text-lg fa-linkedin-in"></i></a>
                                <a className='hover:text-orange-500 ps-5' href="https://instagram.com" title="Instagram" itemprop="url" target="_blank"><i class="fa-brands text-lg fa-instagram"></i></a>
                            </div>
                        </div>
                        <div className='flex justify-center'>
                            <svg fill='rgb(219, 158, 48)' className="fill-theme relative left-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 281">
                                <g>
                                    ...
                                    <image href={AllahName} x="33" y="80" height="120" width="120" />
                                </g>
                            </svg>
                        </div>
                        <div className='flex justify-end'>
                            <div className='flex flex-col gap-y-7'>
                                ...
                                <div className='flex items-center gap-x-3'>
                                    <div className='grid place-items-center shadow-[0_0_1px_1.5px_rgba(255,255,255,1)] bg-amber-600 w-12 h-12 rounded-full'>
                    ...
                    <div className='border-t border-[rgb(109,107,107)] mt-20'>
                        <p className='font-poppins text-center mt-10'>Virtal Quran School &copy; Copyright 2024, <span className='text-amber-500'>All Rights Reserved</span></p>
                    </div>
                </div>
            </div>
        </div>
