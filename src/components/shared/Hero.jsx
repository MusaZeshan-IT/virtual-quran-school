...
const Hero = () => {
    return (
        <section className="relative bg-cover bg-center h-96 grid place-items-center" style={{ backgroundImage: `url(${CourseBg})` }}>
            <div>
                <h2 className="xs-custom:text-5xl xs-custom:leading-[48px] text-center xs:text-[38px] xs:leading-[38px] text-[30px] leading-[30px] font-semibold font-poppins tracking-wide text-white">404 Page Not Found</h2>
